...
ARG JENKINS_SHA=5840c57afd1f73d83ac728fb52336253cda3b6fdf3ecb26ca045d12bf4bd816e
...
RUN apt-get install -y unzip curl apt-transport-https software-properties-common python-setuptools python-pip
